...
Vision proporciona el reconocimiento base del sistema. Al descargar un paquete de PP-OCRv6, la cámara usa los modelos de detección y reconocimiento convertidos a Core ML. En Ajustes se puede elegir entre Ligero, Equilibrado y Máxima precisión. El tamaño de descarga y la puntuación de reconocimiento se leen directamente de [`OCRModelTier`](../Verto/Camera/OCRModelPack.swift). El coreano siempre usa el reconocimiento de texto del sistema. El paquete Ligero no incluye kana japonés, así que el japonés también usa el reconocimiento del sistema con ese nivel.
